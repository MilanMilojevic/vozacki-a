...
export function napraviAtlas(X) {
  ...
  // Слике које нису знак (атлас) приказују СИТУАЦИЈУ на путу, а тачан одговор каже шта се сме
  // или мора. Уз картицу теме то су исте оне слике које ће се видети на испиту, са питањем и
  // тачним одговором. Колико их је — не пише овде него га билд мери и испише („situacije: N").
