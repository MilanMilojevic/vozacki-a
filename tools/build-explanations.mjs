...
CARDS['preticanje'] = {
  title: 'Preticanje i obilaženje',
  html: `
<p><b>Osnovno (čl. 53):</b> pretiče se SA LEVE strane. Sa DESNE se mora preteći vozilo za koje se po položaju i znaku sigurno zaključuje da skreće ulevo; tramvaj na šinama po sredini kolovoza sme se preteći samo zdesna, ako tamo postoji saobraćajna traka. Isto pravilo za vozilo koje skreće ulevo važi i na raskrsnici na putu sa prvenstvom (čl. 57).</p>
<p><b>Zašto baš zdesna:</b> vozilo koje skreće ulevo i tramvaj na šinama po sredini kolovoza drže levu stranu zauzetu. Zdesna se ne pretiče po slobodnom izboru, već samo u propisanim slučajevima.</p>
<div class="signRow lineRow" style="max-width:360px;margin:6px auto">
  <div class="signCell">
    <svg viewBox="0 0 160 150" role="img" aria-label="Vozilo skreće ulevo — pretiče se s desne strane">
      <rect x="0" y="0" width="160" height="150" fill="#7f8c99"/>
      ...
      <polygon points="142,80 151,89 142,98 133,89" fill="#f2c200" stroke="#101820" stroke-width="4" stroke-linejoin="round"/><polygon points="142,80 151,89 142,98 133,89" fill="#f2c200" stroke="#fff" stroke-width="2.5" stroke-linejoin="round"/>
      ...
      <path d="M108 106 L108 10" stroke="#123e24" stroke-width="3" fill="none" stroke-dasharray="6 5"/>
      <path d="M102 16 L108 6 L114 16" stroke="#123e24" stroke-width="3" fill="none" stroke-linecap="round" stroke-linejoin="round"/>
      ...
      <path d="M100 114 C78 106 58 98 58 78 L58 44" stroke="#612017" stroke-width="3" fill="none" stroke-dasharray="6 5"/>
      <path d="M52 52 L58 42 L64 52" stroke="#612017" stroke-width="3" fill="none" stroke-linecap="round" stroke-linejoin="round"/>
      <g transform="translate(58 94)"><circle r="11" fill="#fff" stroke="#612017" stroke-width="3"/><path d="M-5 -5 L5 5 M5 -5 L-5 5" stroke="#612017" stroke-width="3" stroke-linecap="round"/></g>
    </svg>
  ...
  <div class="signCell">
    <svg viewBox="0 0 160 150" role="img" aria-label="Tramvaj na šinama po sredini kolovoza — pretiče se samo s desne strane">
      ...
      <line x1="74" y1="0" x2="74" y2="150" stroke="#1c2e40" stroke-width="1.6"/><line x1="86" y1="0" x2="86" y2="150" stroke="#1c2e40" stroke-width="1.6"/>
      <rect x="70" y="20" width="20" height="72" rx="4" fill="#b7332b" stroke="#101820" stroke-width="1.2"/>
      ...
      <path d="M120 106 L120 10" stroke="#123e24" stroke-width="3" fill="none" stroke-dasharray="6 5"/>
      <path d="M114 16 L120 6 L126 16" stroke="#123e24" stroke-width="3" fill="none" stroke-linecap="round" stroke-linejoin="round"/>
      ...
      <path d="M112 114 C92 106 56 104 56 82 L56 66" stroke="#612017" stroke-width="3" fill="none" stroke-dasharray="6 5"/>
      <path d="M50 74 L56 64 L62 74" stroke="#612017" stroke-width="3" fill="none" stroke-linecap="round" stroke-linejoin="round"/>
      <g transform="translate(56 96)"><circle r="11" fill="#fff" stroke="#612017" stroke-width="3"/><path d="M-5 -5 L5 5 M5 -5 L-5 5" stroke="#612017" stroke-width="3" stroke-linecap="round"/></g>
    </svg>
    <b>TRAMVAJ PO SREDINI</b><span>šine po sredini kolovoza → SAMO zdesna, i to samo ako desno postoji saobraćajna traka</span>
  </div>
</div>
<p><b>NIJE preticanje (čl. 53 st. 4–5):</b> na putu sa ≥2 trake u istom smeru, na kome su kolone, brže kretanje jedne kolone od druge; u naselju, na putu sa najmanje dve trake u istom smeru, prolazak zdesna pored vozila koje se ne kreće krajnjom desnom trakom.</p>
<div class="vgrid" style="grid-template-columns:1fr 1fr">
  <div class="vg vgFast"><b>❌ ZABRANJENO (čl. 55 i 57)</b></div><div class="vg vgSlow"><b>✅ NIJE SAMO PO SEBI ZABRANJENO</b></div>
  <div class="vg" style="text-align:left">kolonu (posebno pod pratnjom) · kad te neko iza već pretiče · kad je vozač ispred dao znak za preticanje ili obilaženje · kad se ne možeš bezbedno vratiti · zaustavnom ili sporom trakom · preko pune linije uz korišćenje trake suprotnog smera* · početak prevoja, prevoj i nepregledna krivina** · tunel** · neposredno ispred raskrsnice i na raskrsnici koja nije kružna, osim slučajeva iz čl. 57 st. 2 · prelaz preko pruge · vozilo koje prilazi pešačkom prelazu ili ga prelazi, odnosno staje radi pešaka · mesto zabranjeno signalizacijom</div>
  <div class="vg" style="text-align:left">podvožnjak i nadvožnjak · na raskrsnici sa kružnim tokom · na putu sa prvenstvom, samo slučajevi iz čl. 57 st. 2: vozilo koje skreće ulevo (zdesna), vozilo koje skreće udesno bez ulaska u suprotni smer, vozilo koje se kreće putem sa prvenstvom, raskrsnica regulisana semaforom ili policajcem, bicikl/moped/motocikl · sneg sam po sebi ne zabranjuje radnju<br><br>U svim slučajevima i dalje važe opšti uslovi bezbednosti i saobraćajna signalizacija.</div>
</div>
<p class="mut">* Obilaženje preko pune linije dopušteno je pod uslovima iz čl. 55 st. 1. Pod istim uslovima, zabrane iz tač. 14 i 15 ne važe kada se pretiče ili obilazi lako električno vozilo, bicikl, radna mašina, traktor, motokultivator ili zaprežno vozilo.<br>** Prevoj, nepregledna krivina i tunel nisu zabranjeni kada u tvom smeru postoje najmanje dve trake. Obilaženje zaustavljene kolone zabranjeno je kada se posle radnje ne možeš bezbedno uključiti u traku svog smera.</p>
<p><b>Dužnosti (čl. 54 i 56):</b> vozač ne sme da ubrzava dok ga pretiču; ako mu je dat znak za preticanje, pomera vozilo ka desnoj ivici. Posle preticanja vraćaš se u svoju traku bez ometanja ili ugrožavanja drugih.</p>
<p class="mut">Pamćenje: neposredno ispred kružnog toka ne pretičeš; na kružnom toku sama lokacija nije zabrana. U tunelu, na prevoju i u nepreglednoj krivini izuzetak od zabrane traži najmanje dve trake u tvom smeru. Opšti uslovi i signalizacija uvek ostaju.</p>
...
<svg viewBox="0 0 220 170" role="img" aria-label="Motocikl ne sme da prođe pored vozila koje se zaustavilo pred pešačkim prelazom radi propuštanja pešaka" style="max-width:250px;width:100%;display:block;margin:8px auto">
  <rect x="0" y="0" width="30" height="170" fill="#e8dcc2"/><rect x="190" y="0" width="30" height="170" fill="#e8dcc2"/>
  <rect x="30" y="0" width="160" height="170" fill="#7f8c99"/>
  ...
  <g transform="translate(150 146)">
    ...
    <rect x="-4" y="-9" width="8" height="19" rx="4" fill="#2c6aa0" stroke="#101820" stroke-width="1.2"/>
    <rect x="-9" y="-8" width="18" height="3" rx="1.5" fill="#333"/>
    <circle cy="2" r="4.5" fill="#612017"/>
  </g>
  <path d="M141 140 C115 132 100 120 100 100 L100 48" stroke="#612017" stroke-width="3" fill="none" stroke-dasharray="6 5"/>
  <path d="M94 56 L100 46 L106 56" stroke="#612017" stroke-width="3" fill="none" stroke-linecap="round" stroke-linejoin="round"/>
  <g transform="translate(118 88)"><circle r="11" fill="#fff" stroke="#612017" stroke-width="3"/><path d="M-5 -5 L5 5 M5 -5 L-5 5" stroke="#612017" stroke-width="3" stroke-linecap="round"/></g>
...
<tr><td>4</td><td>sam zahteva analizu krvi/urina</td></tr>
...
<div style="display:flex;justify-content:center;margin:6px 0">
<svg viewBox="0 0 320 300" style="max-width:400px;width:100%" role="img" aria-label="Vozač pod dejstvom alkohola: sa sadržajem do 1,20 mg per ml, uključujući 1,20, zadržava se samo ako preti da nastavi vožnju, sa sadržajem većim od 1,20 zadržava se obavezno do otrežnjenja najduže 12 sati. Odbijanje ispitivanja povlači isto obavezno zadržavanje. Donja granica nije nacrtana: po opštem pravilu iznosi više od 0,20 mg/ml, dok za kategorije iz člana 187 stav 4 važi nulta tolerancija."><defs><linearGradient id="alkPodDejstvom" x1="0" y1="0" x2="1" y2="0"><stop offset="0" stop-color="#e8b000" stop-opacity="0"/><stop offset="0.12" stop-color="#e8b000" stop-opacity="1"/><stop offset="1" stop-color="#e8b000" stop-opacity="1"/></linearGradient></defs><rect x="10" y="3" width="300" height="46" rx="5" fill="none" stroke="#c0392b" stroke-width="2"/><text x="160" y="22" text-anchor="middle" font-size="14" fill="currentColor">ODBIJE ISPITIVANJE →</text><text x="160" y="41" text-anchor="middle" font-size="14" fill="currentColor">isto: obavezno zadržavanje</text><path d="M255 49 L255 66" stroke="#c0392b" stroke-width="2"/><polygon points="255,77 249,64 261,64" fill="#c0392b"/><rect x="14" y="82" width="194" height="28" fill="url(#alkPodDejstvom)"/><rect x="212" y="82" width="94" height="28" fill="#c0392b"/><line x1="210" y1="74" x2="210" y2="118" stroke="currentColor" stroke-width="2"/><text x="210" y="70" text-anchor="middle" font-size="14" fill="currentColor">1,20</text><text x="120" y="101" text-anchor="middle" font-size="14" fill="#2a333d">POD DEJSTVOM</text><text x="286" y="130" text-anchor="middle" font-size="14" fill="currentColor">mg/ml</text><rect x="14" y="142" width="14" height="14" fill="#e8b000"/><text x="36" y="154" font-size="14" fill="currentColor">DO 1,20 (uključujući):</text><text x="36" y="172" font-size="14" fill="currentColor">zadržan SAMO ako preti da</text><text x="36" y="190" font-size="14" fill="currentColor">nastavi vožnju posle isključenja</text><rect x="14" y="206" width="14" height="14" fill="#c0392b"/><text x="36" y="218" font-size="14" fill="currentColor">VEĆI od 1,20:</text><text x="36" y="236" font-size="14" fill="currentColor">OBAVEZNO zadržan do otrežnjenja,</text><text x="36" y="254" font-size="14" fill="currentColor">najduže 12 h</text><text x="160" y="278" text-anchor="middle" font-size="14" fill="currentColor">žuta traka važi samo za vozača</text><text x="160" y="295" text-anchor="middle" font-size="14" fill="currentColor">POD DEJSTVOM alkohola</text></svg>
</div>
<p><b>Isto to rečima:</b> vozač koji je POD DEJSTVOM alkohola sa sadržajem u krvi VEĆIM od 1,20 mg/ml zadržava se OBAVEZNO, do otrežnjenja, najduže 12 sati (#8569). Vozač koji je POD DEJSTVOM alkohola, a sadržaj mu je do 1,20 mg/ml, uključujući i tu vrednost (recimo 1,00) — može biti zadržan SAMO ako izražava nameru, odnosno ako postoji opasnost da će nastaviti da upravlja vozilom pošto je isključen; nije uslov da je izazvao nezgodu i nema obaveznog zadržavanja (#8571, #8572). Uslov „pod dejstvom alkohola" je deo pravila: obe rečenice polaze od njega. Ko ODBIJE ispitivanje: isključenje iz saobraćaja <b>i obavezno zadržavanje</b> — ne „samo isključenje", i ne sprovođenje na analizu krvi (#8570).</p>
<p><b>Test i osporavanje:</b> po nalogu ovlašćenog lica dužan si da postupiš BEZ ODLAGANJA i omogućiš ispitivanje (alkometar i dr.); obaveza je bezuslovna — ne oslobađa te ni to što tražiš analizu krvi, ni to što prekineš vožnju (#8559, #8560). Analizu krvi, odnosno krvi i urina tražiš o SOPSTVENOM trošku i samo ako OSPORAVAŠ rezultat već izvršenog ispitivanja (#8561), i to u PISANOJ formi, NA LICU MESTA, u zapisnik u kome su utvrđeni rezultati — ne usmeno i ne „u roku od 24 sata" (#8562). <b>Ali pazi:</b> i sam zahtev za analizu krvi, odnosno urina jeste razlog da te privremeno isključe iz saobraćaja (#8553; stavka 4 liste sa vrha kartice).</p>
...
<tr><td>Kada</td><td>kad policijski službenik POSUMNJA u tehničku ispravnost — sumnja je dovoljna (#8575)</td><td>nakon opravke i pre puštanja u saobraćaj vozila kome su oštećeni vitalni sklopovi i uređaji, odnosno koje nakon toga nije bilo u voznom stanju, kao i vozila isključenog zbog neispravnosti utvrđene na kontrolnom pregledu (#8575, #8599, #8600)</td></tr>
...
<p><b>Redosled:</b> sumnja → kontrolni pregled → ako se utvrdi neispravan uređaj za upravljanje ili zaustavljanje, odnosno drugi uređaji i oprema neispravni tako da mogu ugroziti bezbednost i životnu sredinu, vozilo se isključuje (#8584) → nakon opravke vanredni pregled, po pravilu tamo gde je bio kontrolni (#8599, #8600).</p>
...
<div style="display:flex;justify-content:center;margin:6px 0">
<svg viewBox="0 0 320 304" style="max-width:400px;width:100%" role="img" aria-label="Premeštanje: gore isključeno vozilo stoji na kolovozu tako da saobraćaj ne može da prođe, pa sme da se premesti; dole isto takvo vozilo stoji tako da saobraćaj slobodno prolazi, pa se ne premešta. Kriterijum je ometanje saobraćaja, a ne mesto na kome vozilo stoji."><text x="160" y="15" text-anchor="middle" font-size="14" fill="currentColor">PREMEŠTANJE: pitanje je da li</text><text x="160" y="33" text-anchor="middle" font-size="14" fill="currentColor">vozilo OMETA saobraćaj</text><rect x="8" y="50" width="304" height="46" fill="#43515e"/><rect x="112" y="56" width="76" height="20" rx="4" fill="none" stroke="#fff" stroke-width="2"/><circle cx="130" cy="79" r="6" fill="none" stroke="#fff" stroke-width="2"/><circle cx="172" cy="79" r="6" fill="none" stroke="#fff" stroke-width="2"/><path d="M18 68 L84 68" fill="none" stroke="#f0918a" stroke-width="3"/><line x1="92" y1="60" x2="106" y2="76" stroke="#f0918a" stroke-width="3"/><line x1="106" y1="60" x2="92" y2="76" stroke="#f0918a" stroke-width="3"/><text x="160" y="118" text-anchor="middle" font-size="14" fill="currentColor">saobraćaj ne može da prođe</text><text x="160" y="136" text-anchor="middle" font-size="14" fill="currentColor">OMETA → sme da se premesti</text><rect x="8" y="154" width="304" height="64" fill="#43515e"/><line x1="10" y1="194" x2="310" y2="194" stroke="#fff" stroke-width="2" stroke-dasharray="12 10"/><rect x="112" y="160" width="76" height="20" rx="4" fill="none" stroke="#fff" stroke-width="2"/><circle cx="130" cy="183" r="6" fill="none" stroke="#fff" stroke-width="2"/><circle cx="172" cy="183" r="6" fill="none" stroke="#fff" stroke-width="2"/><path d="M20 206 L286 206" fill="none" stroke="#79d89a" stroke-width="3"/><polygon points="300,206 286,200 286,212" fill="#79d89a"/><text x="160" y="240" text-anchor="middle" font-size="14" fill="currentColor">saobraćaj prolazi</text><text x="160" y="258" text-anchor="middle" font-size="14" fill="currentColor">NE OMETA → ne premešta se</text><text x="160" y="281" text-anchor="middle" font-size="14" fill="currentColor">isto vozilo na kolovozu — razlikuje se</text><text x="160" y="298" text-anchor="middle" font-size="14" fill="currentColor">samo to da li saobraćaj može da prođe</text></svg>
</div>
...
<p><b>Uklanjanje je druga mera.</b> Ako je vozač prisutan, naređuje mu se da nepropisno parkirano ili zaustavljeno vozilo ODMAH ukloni, pod pretnjom prinudnog izvršenja (#8606). Ako nije prisutan, pisano rešenje postavlja se na vidno mesto vozila; kada je prekršaj utvrđen video-nadzorom ili foto-zapisom, donosi se elektronsko rešenje i postavlja obaveštenje. Rok iz rešenja ne može biti kraći od jednog minuta. Ako vozilo ne bude uklonjeno u tom roku, uklanja se na određeno mesto o trošku vozača ili vlasnika, odnosno korisnika (#8609). Za štete od započinjanja uklanjanja do preuzimanja vozila odgovara pravno lice, odnosno preduzetnik kome je uklanjanje povereno (#8611).</p>
<table>
...
CARDS['znakovi-opasnosti'] = {
  ...
  html: `
<p><b>Ključ za slikovna pitanja:</b> znak opasnosti upozorava na opasnost koja preti na određenom mestu ili delu puta. Zato tačan odgovor opisuje približavanje, nailazak, blizinu, početak ili udaljenost — ne naredbu („moraju se kretati", „zabranjeno je") niti opis izgrađenog objekta („posebno izgrađena staza", „mesto na kome se nalazi...").</p>
...
<tr><td>U naselju, bliže od 150 m</td><td>sme uz obrazloženje u saobraćajnom projektu; <b>NE MORA</b> imati dopunsku tablu sa udaljenošću</td></tr>
<tr><td>Van naselja, bliže od 150 m ILI dalje od 250 m</td><td><b>MORA</b> imati dopunsku tablu sa udaljenošću i obrazloženje u saobraćajnom projektu</td></tr>
</table>
<p class="mut">Pamtilica za opšte pravilo iz čl. 22: van naselja odstupanje od 150–250 m traži tablu sa udaljenošću; u naselju znak sme bliže i bez nje. Oba odstupanja moraju biti obrazložena u saobraćajnom projektu, a čl. 23 propisuje posebna mesta za pojedine znakove.</p>

</div>
<div class="kPodH"><b class="kPodNaslov">Pruga — znaci i značenja</b>
<table>
...
<tr><td class="znCel">${zn(10838)}<span class="znOpis">Pešak koji hoda</span></td><td>deo puta kojim se <b>PEŠACI često kreću</b>; važeći Pravilnik ima i poseban znak „starije osobe na putu” za deo puta kojim se starije osobe često kreću</td><td>pešačka staza ni obeležen prelaz</td></tr>
<tr><td class="znCel">${zn(10802)}<span class="znOpis">Biciklista</span></td><td><b>BICIKLISTI I VOZAČI LAKIH ELEKTRIČNIH VOZILA</b> često se kreću, odnosno prelaze put</td><td>biciklistička staza ni zabrana saobraćaja za bicikle</td></tr>
...
CARDS['znakovi-naredbi'] = {
  ...
  html: `<p><b>Svako pitanje iz ove podoblasti nosi 3 poena</b>, a 62 od 65 su slike. Dobra vest: ne bubaš 60 znakova napamet — <b>boja i oblik ti unapred kažu vrstu naredbe</b>, a razlika je često u maloj pojedinosti. Nauči parove, ne pojedinačne znakove.</p>
...
<p><b>Odakle dokle važi naredba</b> Opšte pravilo i dve prikazane dopunske table:</p>
<table>
...
<tr><td>Dokle važi?</td><td>do <b>PRVE naredne raskrsnice</b>, odnosno do znaka obaveštenja o prestanku te naredbe</td><td>Za nastavak naredbe znak se ponavlja posle raskrsnice sa drugim putem</td></tr>
<tr><td>Gde se postavlja?</td><td><b>NEPOSREDNO ispred</b> mesta odakle nastaje obaveza</td><td>Može i ranije, uz dopunsku tablu sa udaljenošću do mesta od kog naredba važi</td></tr>
<tr><td>Dopunska tabla „200 m" (samo broj)</td><td>znak je postavljen unapred: naredba važi <b>NA UDALJENOSTI od 200 m</b> od znaka</td><td rowspan="2">Kod ove dve table sa oznakom „200 m": <b>samo broj = udaljenost</b> do početka, <b>strelice = dužina</b> važenja</td></tr>
...
<tr><td>plavi krug, <b>jedna</b> strelica</td><td>smer kojim se vozila <b>MORAJU</b> kretati</td><td>„jednosmerni put" i „obaveštenje o jednosmernom putu" su mamci — jednosmerni put označava se PRAVOUGAONIM znakom obaveštenja, a prikazani plavi krug naređuje smer</td></tr>
...
<tr><td><b>prazan krug</b> vs „cigla"</td><td>beli krug sa crvenim obodom <b>bez simbola</b> = zabranjen saobraćaj za <b>SVA vozila</b> (znak „zabrana saobraćaja za vozila u oba smera"); drugi znak iz para = zabranjen saobraćaj vozilima <b>iz smera prema kome je okrenuto lice znaka</b> („u jednom smeru" — sam ovaj znak ne zabranjuje suprotan smer)</td></tr>
...
<tr><td>zabrana preticanja: auto vs kamion</td><td>od dva simbola vozila <b>levi je crven</b> (Pravilnik, čl. 29). Crven <b>auto</b> = motorna vozila ne smeju da pretiču druga motorna vozila, <b>osim motocikla sa dva točka bez prikolice i mopeda koji se PRETIČU</b>; crven <b>kamion</b> = zabrana preticanja za teretna vozila <b>čija najveća dozvoljena masa prelazi 3,5 t</b></td></tr>
<tr><td>Zabrana prolaska bez zaustavljanja</td><td>krug sa crvenim obodom + natpis = naredba da <b>zaustaviš vozilo iz razloga označenog na znaku</b>: policija, naplatno mesto za putarinu, carinarnica — tri znaka, ista rečenica, menja se samo razlog u zagradi</td></tr>
...
<p><b>Kome je zabranjeno — životinjski svet vozila.</b> Simbol pomaže da prepoznaš zabranu, ali pročitaj i njeno puno značenje. Na primer, znak sa biciklom zabranjuje saobraćaj <b>biciklima i lakim električnim vozilima</b>, iako trotinet nije nacrtan. Odgovor sačuvane baze uz tu sliku navodi bicikle; važeći Pravilnik obuhvata obe vrste vozila.</p>
<table>
...
<tr><td>točak <b>s lancem</b> (plavi krug)</td><td>lanci za sneg na pogonskim točkovima, <b>ako je na kolovozu sneg</b></td><td>obaveza <b>NE važi</b> za motocikle, mopede, tricikle, četvorocikle, radne mašine, traktore i motokultivatore — motocikl je izuzet od ove obaveze</td></tr>
...
<tr><td>opasan teret</td><td>tri zabrane: vozila koja prevoze <b>eksploziv ili lako zapaljive materije</b>; vozila koja prevoze <b>opasne terete</b>; vozila koja prevoze određenu količinu materija koje mogu da <b>zagade vodu</b> (na tom znaku su dve PLAVE linije — voda; Pravilnik, čl. 29)</td><td>jedini <b>PRAVOUGAONIK</b> među naredbama: <b>obavezan smer kretanja za vozila koja prevoze opasan teret</b> — gore simbol tereta, dole obavezan smer</td></tr>
</table>
<p class="mut">Znak zabrane za teretna vozila + dopunska tabla sa masom → zabrana važi samo za teretna vozila čija najveća dozvoljena masa prelazi označenu (Pravilnik, čl. 25).</p>
...
<tr><td>Broj sa oznakom <b>t</b>, bez simbola osovine</td><td><b>ukupna MASA</b> prelazi označenu — i za skupove vozila</td></tr>
...
<p class="mut"><b>Taktika za slike:</b> boja i oblik su početni trag, ali proveri simbol, izuzetke i <b>rep tačnog odgovora</b> — kod ovih pitanja gotovo svi odgovori počinju isto („put, odnosno deo puta na kome je zabranjen saobraćaj…"), a razlika je često u završetku rečenice: „osim…", „u kretanju", „stranu puta", „moraju/smeju/mogu".</p>`,
};
...
X[10792] = { x: 'Simbol prikazuje pokretni most čija se ploča može podići radi prolaza plovila. Zato odgovor govori o blizini pokretnog mosta. Put koji vodi do obale prikazuje vozilo koje pada u vodu, a klizav kolovoz vozilo sa vijugavim tragovima.' };
...
X[10802] = { x: 'Važeći Pravilnik ovaj znak naziva „biciklisti i vozači lakih električnih vozila na putu”: upozorava na deo puta na kome se oni često kreću, odnosno prelaze put (čl. 18 tač. 13). Ponuđeni tačan odgovor iz javne banke navodi bicikliste i uži je od današnjeg punog značenja, ali jedini opisuje ovu opasnost; plavi krug označava stazu, a crveni krug zabranu.' };
...
X[10805] = { x: 'Ovo je jedini znak opasnosti sa žutom osnovom: „radovi na putu”. Čovek sa lopatom označava deo puta na kome se izvode radovi. Suženje kolovoza prikazuju ivice koje se približavaju na belom trouglu, dok je „naizmenično uključivanje vozila” plava pravougaona tabla obaveštenja.' };
...
X[10817] = { x: 'Kraci krsta su iste debljine: nijedan od puteva koji se ukrštaju nije put sa prvenstvom prolaza. Ako prvenstvo nije drugačije regulisano, primenjuju se opšta pravila, uključujući pravilo desne strane. Da jedan put ima prvenstvo, bio bi nacrtan deblje; železnička pruga ima drugi simbol, sa lokomotivom.' };
...
X[10824] = { x: 'Beli trougao sa crvenim okvirom samo upozorava na raskrsnicu sa kružnim tokom i ništa ne naređuje. Tri crne strelice povezane u krug opisuju tok saobraćaja. Sam znak opasnosti ne određuje prvenstvo prolaza; njega proveri po ostaloj signalizaciji i pravilima. Obilaženje ostrva propisuje plavi krug sa strelicom, a zabranu polukružnog okretanja crveni krug.' };
...
X[10831] = { x: 'Andrejin krst je jedan od retkih znakova opasnosti koji nije trougao nego pravougaona tabla sa crvenim kracima, i stoji neposredno pred prelazom preko pruge. Ovde je krst sa dodatnim donjim krakovima, a to znači prugu sa dva ili više koloseka; krst bez tih dodatnih krakova značio bi jedan kolosek. Da li prelaz ima branike ne čita se sa krsta nego sa trougla postavljenog ispred njega.' };
...
X[10840] = { x: 'Andrejin krst nije trougao nego pravougaona tabla sa crvenim kracima i postavlja se neposredno pred prelazom preko pruge. Ovde je nacrtan krst bez dodatnih donjih krakova, a to znači prugu sa jednim kolosekom; krst sa dodatnim donjim krakovima značio bi dva ili više koloseka. Da li prelaz ima branike govori trougao postavljen ispred, a ne sam krst, pa i ta ponuda pada.' };
...
X[9017] = { x: 'Beli krug sa crvenim obodom i siluetom kamiona zabranjuje saobraćaj teretnim vozilima; ne određuje smer kojim se ona moraju kretati. Znak za eksploziv ili lako zapaljive materije ima prasak iznad vozila, dok znak za opasne terete ima crveni teret oivičen crnim linijama. Ovde je obična crna silueta kamiona.' };
...
X[9019] = { x: 'Na znaku je simbol mopeda: zabrana važi za mopede, lake tricikle i lake četvorocikle. Znak sa motociklom odnosi se na motocikle, teške tricikle i teške četvorocikle. Ne mešaj ih sa simbolom bicikla: prema važećem Pravilniku zabrana sa tim simbolom obuhvata bicikle i laka električna vozila.' };
...
X[9023] = { x: 'Bicikl u belom krugu sa crvenim obodom označava zabranu, pa je među ponuđenim odgovorima tačan onaj o zabrani saobraćaja za bicikle. Važeći Pravilnik ovim znakom obuhvata i laka električna vozila. Plavi krug sa biciklom označava biciklističku stazu; ovde nije ni staza ni prestanak zabrane.' };
...
X[9033] = { x: 'Iznad vozila je nacrtan crveni prasak, simbol za eksploziv i lako zapaljive materije, pa se zabrana odnosi samo na vozila sa takvim teretom. Materije koje mogu da zagade vodu imaju svoj znak, na kome su nacrtane linije vode, a znak za opasne terete ima crveni teret oivičen crnim linijama. Teretnom vozilu bez takvog tereta ovaj znak ništa ne brani.' };
X[9034] = { x: 'Na znaku je crveni teret oivičen crnim linijama iznad osovine i točkova. To je zabrana saobraćaja vozilima koja prevoze opasne terete. Znak za eksploziv ili lako zapaljive materije ima prasak iznad vozila, a zabrana za teretna vozila običnu crnu siluetu kamiona. Ne zaključuj da je nacrtana cisterna ili poseban rezervoar.' };
X[9037] = { x: 'Traktor u belom krugu sa crvenim obodom označava zabranu saobraćaja za traktore, a ne obavezu njihovog kretanja tim putem. Zabrana za sva motorna vozila ima automobil i motocikl. Zato se prikazani znak odnosi baš na traktore.' };
X[9038] = { x: 'Konj upregnut u kola predstavlja zaprežno vozilo: njemu je prolaz ovim znakom zabranjen. To nije opšta zabrana za domaće životinje. Znak koji zabranjuje saobraćaj svim motornim i zaprežnim vozilima uz zapregu ima automobil i motocikl.' };
...
X[9053] = { x: 'Plavi krug sa jednom belom strelicom je naredba: nudi ti se jedan jedini smer i njime moraš da se krećeš. Jednosmerni put se označava pravougaonim znakom obaveštenja; prikazani plavi krug sa strelicom označava obavezan smer. Kad bi znak nudio dva kraka, odgovor bi glasio da se vozila smeju kretati; sa jednom strelicom ostaje moraju.' };
...
X[9068] = { x: 'Strelice raspoređene u krug na plavoj podlozi nisu najava nego naredba: ostrvo za usmeravanje saobraćaja obilaziš tačno u smeru koji strelice pokazuju. Oba mamca počinju sa blizinom raskrsnice, a najavu daju znakovi opasnosti i obaveštenja. Prikazani znak naređuje smer obilaženja ostrva, a ne samo blizinu kružnog toka.' };
...
X[10848] = { x: 'Dva automobila, od kojih je levi crven, označavaju zabranu da motorna vozila pretiču druga motorna vozila. Izuzetak se odnosi na vozilo koje se PRETIČE: motocikl sa dva točka bez prikolice ili moped. Teretna vozila, autobusi i skupovi vozila nisu taj izuzetak. Kod posebne zabrane za teretna vozila levo je crveni kamion, a desno crni automobil — ne dva kamiona.' };
...
X[10856] = { x: 'Crveni krug je zabrana, a nacrtani su vučno i priključno vozilo. Znak zabranjuje vuču priključnog vozila, ali sa repom „osim poluprikolice ili prikolice sa jednom osovinom“. Odgovor bez tog izuzetka pripada drugom, vrlo sličnom znaku koji zabranjuje vuču bilo kog priključnog vozila. Zabrana za teretna vozila je treći znak — na njemu je nacrtan samo kamion, bez prikolice.' };
X[10857] = { x: 'U crvenom krugu je lice sa ručnim kolicima, pa je zabranjen saobraćaj licima koja koriste takva kolica. Znak ne određuje put kojim se ona moraju kretati. Zabrana za pešake je poseban znak sa figurom pešaka bez kolica.' };
...
X[10873] = { x: 'Isti mehanizam kao kod znaka sa strelicom nagnutom na suprotnu stranu: plavi krug naređuje, a nagib strelice kaže kojom stranom prolaziš pored ostrva ili drugog objekta na kolovozu. Pošto je ponuđen samo jedan smer, važi „moraju se kretati“. Strelica pokazuje obaveznu stranu obilaženja, a ne ulaz u podzemni prolaz za vozila. Jednosmerni put označava se pravougaonim znakom obaveštenja.' };
...
X[11068] = { x: 'U crvenom krugu je nacrtano samo priključno vozilo, bez ikakvog izuzetka, pa je zabranjena vuča bilo kog priključnog vozila. Vrlo slična zabrana sa repom „osim poluprikolice ili prikolice sa jednom osovinom“ je poseban znak, na kome je uz prikolicu nacrtano i vučno vozilo. Zabrana za teretna vozila je treći znak — na njemu je kamion bez ičega prikačenog.' };
...
X[9723] = { x: 'Na slici plavo vozilo pokušava da prođe sa leve strane, iako je vozilo ispred zauzelo položaj i dalo znak za skretanje ulevo. Takvo preticanje sleva nije dozvoljeno. Vozilo za koje se sa sigurnošću može zaključiti da skreće ulevo pretiče se sa desne strane, ako su ispunjeni opšti uslovi (ZOBS čl. 53 st. 2).' };
...
X[9730] = { x: 'Znak na slici označava početak naselja, a put ima najmanje dve saobraćajne trake u istom smeru. Prolazak zdesna pored vozila koje se ne kreće krajnjom desnom trakom u tom slučaju ne smatra se preticanjem (ZOBS čl. 53 st. 5). Mimoilaženje otpada jer se vozila kreću u istom smeru.' };
...
X[9739] = { x: 'Vozač vozila koje se pretiče ne sme da povećava brzinu kretanja svog vozila (ZOBS čl. 54 st. 2). Nije dužan da uspori. Pomeranje ka desnoj ivici posebna je obaveza vozača kome je dat znak za preticanje (st. 1), a taj uslov ovde nije naveden.' };
X[9741] = { x: 'Vozač teretnog vozila koje se pretiče ne sme da povećava brzinu kretanja (ZOBS čl. 54 st. 2), ali nije dužan da uspori. Pomeranje ka desnoj ivici obavezno je kada mu je dat znak za preticanje (st. 1); slika i pitanje taj uslov ne navode.' };
...
X[9750] = { x: 'Desni pokazivač na teretnom vozilu ispred tebe znači da ono skreće ili se pomera udesno, a nije poziv tebi da kreneš u preticanje. Njegova karoserija zaklanja pogled na put ispred, pa uslov da se neposredno uveriš u bezbednost nije ispunjen. Ni znak rukom to ne bi promenio — nijedan vozač ti ne može dati dozvolu umesto tvoje procene.' };
X[9752] = { x: 'Teretno vozilo daje desni pokazivač, što govori da ono skreće ili staje desno, a ne da je tebi javilo da je put slobodan. Kao vozač koji pretiče, moraš sam da se uveriš da radnju možeš bezbedno da izvršiš. Dodatni razlog za oprez je što takvo vozilo pred skretanjem može naglo da uspori.' };
...
X[9762] = { x: 'Znak zabranjuje da motorna vozila pretiču druga motorna vozila, osim motocikla sa dva točka bez prikolice i mopeda. Ispred je putnički automobil, pa se zabrana na njega odnosi. Naredba važi od znaka; započinjanje radnje neposredno pre njega ne dopušta da se preticanje nastavi u zoni zabrane.' };
...
X[9770] = { x: 'Na prikazanom auto-putu vozila nisu u kolonama, a vozilo ispred je u tvojoj traci, pa bi prolazak zdesna bio nedozvoljeno preticanje; pretiče se sleva (ZOBS čl. 53 st. 1 i 4). U naselju, pod uslovima iz st. 5, prolazak zdesna se ne smatra preticanjem, zato ponuđeno „preticanje zdesna samo u naselju” pogrešno naziva tu radnju.' };
X[9772] = { x: 'Na prikazanom auto-putu žuta putanja vodi zdesna pored teretnog vozila, što nije dozvoljeno preticanje; pretiče se sleva (ZOBS čl. 53 st. 1). Posebno pravilo za put u naselju iz st. 5 ovde ne važi, a radnju koju ono dopušta zakon ne smatra preticanjem, pa je i taj ponuđeni odgovor netačan.' };
X[9774] = { x: 'Na prikazanom motoputu žuta putanja vodi desno od teretnog vozila, izvan saobraćajne trake, pa takvo preticanje nije dozvoljeno; osnovno pravilo je prolazak sleva (ZOBS čl. 53 st. 1). Posebni slučajevi u kojima se brže kretanje ili prolazak zdesna ne smatra preticanjem (st. 4 i 5) nisu prikazani.' };
...
X[9789] = { x: 'Od suprotnog smera te deli dvostruka puna linija, a isprekidana linija desno od tvoje trake otvara još jednu traku istog smera — njome se kreće crveno vozilo. Pošto u tvom smeru postoje dve trake, preticanje ne traži ulazak u traku za suprotni smer, pa zabrana zbog nepregledne krivine ovde ne važi. Ovaj izuzetak nije ograničen samo na putnička vozila.' };
X[9793] = { x: 'Vozilo ispred tebe koči i zaustavlja se pred pešačkim prelazom, koji je označen i znakom i oznakama na kolovozu, a pešak se sa desne strane sprema da pređe. Preticanje vozila koje staje radi propuštanja pešaka zabranjeno je zato što bi mogao da izletiš pred pešaka koji može biti zaklonjen vozilom. Zabrana važi svuda, i u naselju i van njega.' };
...
X[9797] = { x: 'Šine su neposredno ispred vozila i preticanje započeto u prikazanoj situaciji odvijalo bi se na prelazu puta preko železničke pruge, gde je zabranjeno (ZOBS čl. 55 st. 3 tač. 11). Propis ne navodi zasebnu zabranu „neposredno pre” prelaza; odlučuje to što bi ova radnja zahvatila sam prelaz.' };
X[9799] = { x: 'Crveno vozilo je već uz šine, pa bi se prikazano preticanje odvijalo na prelazu puta preko železničke pruge, gde je zabranjeno (ZOBS čl. 55 st. 3 tač. 11). Svetlosni znak upozorenja ne ukida zabranu. Propis ne zabranjuje posebno svako preticanje „neposredno pre” prelaza; ovde je bitno da bi radnja zahvatila sam prelaz.' };
...
X[9811] = { x: 'Znak zabranjuje da motorna vozila pretiču druga motorna vozila, osim motocikla sa dva točka bez prikolice i mopeda. Ispred je putnički automobil, pa se zabrana na njega odnosi; kratka preglednost dodatno nalaže oprez. Naredba važi od znaka do propisanog prestanka ili ukidanja.' };
X[9813] = { x: 'Znak zabranjuje da motorna vozila pretiču druga motorna vozila, osim motocikla sa dva točka bez prikolice i mopeda. Teretno vozilo ispred nije izuzeto. Isprekidana linija dopušta njen prelazak, ali ne ukida zabranu postavljenu znakom.' };
X[9815] = { x: 'Iz tačke posmatranja bi preko neisprekidane linije trebalo preteći i crni putnički automobil ispred, a on nije među vozilima za koja važi izuzetak iz završnog stava čl. 55. Zato preticanje nije dozvoljeno (čl. 55 st. 3 tač. 15). Važeći zakon pod opštim uslovima dopušta prelazak preko te linije radi preticanja samog traktora, ali taj uži izuzetak ne čini prikazanu radnju pored putničkog automobila dozvoljenom; belo vozilo u suprotnoj traci dodatno sužava prostor.' };
...
X[9820] = { x: 'Put ima dve trake u istom smeru, razdvojene isprekidanom linijom, i plavo vozilo pretiče crveno upravo sa leve strane — tačno onako kako pravilo nalaže. Plavo vozilo pri ovom preticanju ostaje u traci za isti smer, pa ne koristi traku za suprotan smer.' };
X[9821] = { x: 'Vozilo koje bi pretekao je u levoj traci, a ti si u desnoj — prolaz bi bio sa desne strane, a pretiče se sa leve. Zdesna se sme samo izuzetno: vozilo koje je zauzelo položaj za skretanje ulevo ili tramvaj sa šinama po sredini kolovoza. Pravilo za prolazak zdesna pored pojedinačnog vozila koje nije u krajnjoj desnoj traci važi u naselju, a ovde si van njega; brže kretanje kolona iz st. 4 poseban je slučaj.' };
...
X[9852] = { x: 'Motociklista prolazi pored vozila sa njihove desne strane, i to po žutoj liniji, dakle ne krećući se nijednom saobraćajnom trakom. Pretiče se sa leve strane; zdesna samo izuzetno — kad vozilo ispred skreće ulevo ili kad je reč o tramvaju na šinama po sredini kolovoza. Nijednog od tih izuzetaka ovde nema, pa je način izvođenja radnje nepropisan.' };
...
X[9854] = { x: 'Na slici su dve zaustavljene kolone, a uzan prostor između njih nije saobraćajna traka niti omogućava bezbedno uključivanje u traku svog smera. Zato obilaženje nije dozvoljeno (ZOBS čl. 55 st. 4). Ovo nije apsolutna zabrana svakog obilaženja zaustavljene kolone: zakon je zabranjuje kada se vozač posle radnje ne bi mogao bezbedno uključiti u odgovarajuću traku.' };
X[9855] = { x: 'Vozač mopeda, odnosno motocikla, koji se pretiče ne sme da povećava brzinu kretanja (ZOBS čl. 54 st. 2), ali nije dužan da uspori. Pomeranje ka desnoj ivici obavezno je kada mu je dat znak za preticanje (st. 1); pitanje ne navodi da je znak dat.' };
...
X[8093] = { ...(X[8093] || {}), x: "Saobraćajna traka je uzdužni deo kolovozne trake namenjen jednoj koloni vozila. Na slici su to četiri uža pojasa 4, 5, 6 i 7, pa se biraju oba ponuđena para: „5 i 6” i „4 i 7”. Ostale ponuđene strelice ne označavaju po jednu takvu traku." };
...
X[8095] = { ...(X[8095] || {}), x: "Saobraćajna traka je obeleženi ili neobeleženi uzdužni deo kolovozne trake namenjen jednoj koloni vozila. Na slici su to uži pojasevi 4 i 5 sa jedne strane razdelne linije, a 6 i 7 sa druge. Biraju se oba para. Duže strelice 1, 2 i 3 ne označavaju po jednu saobraćajnu traku." };
X[8096] = { ...(X[8096] || {}), x: "Biciklistička traka je saobraćajna traka namenjena isključivo lakim električnim vozilima, biciklima, mopedima i lakim triciklima (ZOBS čl. 7 t. 13). Na slici je to uzani pojas 3, odvojen uzdužnom linijom od susedne trake. Brojevi 1 i 2 označavaju druge saobraćajne trake, a 4 trotoar iza ivičnjaka." };
X[8097] = { ...(X[8097] || {}), x: "Trakom za spora vozila moraju se kretati vozila koja se kreću brzinom manjom od određene, da ne bi ometala ostala vozila (ZOBS čl. 7 t. 14). Na slici je ta dodatna traka označena brojem 4. Plava tabla prikazuje raspored traka i najmanju brzinu 30 km/h za susednu traku; brojevi 2 i 3 označavaju druge trake." };
...
X[8101] = { ...(X[8101] || {}), x: "Na ovoj slici žute linije izdvajaju dve trake za vozila javnog prevoza putnika: 4 na gornjem i 9 na donjem kolovozu. One su ovde uz spoljne ivice. Namena trake, a ne obavezno krajnji desni položaj, određuje ovaj pojam (ZOBS čl. 7 t. 18). Broj 1 zahvata znatno širu celinu, pa nije jedna traka." };
X[8103] = { ...(X[8103] || {}), x: "Tramvajska baštica je posebno uređen deo puta namenjen isključivo kretanju tramvaja (ZOBS čl. 7 t. 20). Na slici je to odvojen pojas sa šinama označen brojem 2. Broj 1 meri deo kolovoza, 4 seče širu celinu, a 3 je na zelenoj površini pored njega." };
X[8104] = { ...(X[8104] || {}), x: "Trotoar je posebno uređen deo puta pored kolovoza, namenjen prvenstveno kretanju pešaka (ZOBS čl. 7 t. 21). Na slici su to pojasevi 1 i 5, ovde odvojeni ivičnjacima. Brojevi 2 i 4 su na kolovozu, a 3 u zoni pešačkog prelaza; prelaz nije trotoar." };
...
X[8109] = { ...(X[8109] || {}), x: "Broj 3 označava pešačku stazu, a 2 susednu biciklističku stazu. Plavi znak sa uspravnom podelom određuje odvojeno kretanje po odgovarajućim stazama. Na kolovozu je pod 1 prelaz biciklističke staze, omeđen nizovima belih polja, dok je pod 4 pešački prelaz sa širokim belim prugama." };
X[8111] = { ...(X[8111] || {}), x: "Broj 2 označava crvenkasti pojas biciklističke staze; ona je po zakonu namenjena biciklima i lakim električnim vozilima. Znak sa uspravnom podelom razdvaja taj pojas od susedne pešačke staze. Broj 3 meri sivi pešački deo, 4 oba dela zajedno, a 1 kolovoz ulice. Položaj bicikliste na fotografiji ne određuje namenu staze: on je ovde na sivom delu." };
...
X[8114] = { ...(X[8114] || {}), x: "Pešačko ostrvo je obeleženi ili uzdignuti deo kolovoza određen za privremeno zadržavanje pešaka pri prelasku ili ulasku i izlasku iz javnog prevoza (ZOBS čl. 7 t. 29). Na slici je to prostor pod 3 između delova prelaska. Broj 1 pokazuje prelaz, 2 trotoar uz ivicu, a 4 obojenu oznaku na kolovozu." };
...
X[8224] = { ...(X[8224] || {}), x: 'Ova sačuvana baza očekuje zatvor od 30 do 60 dana i 15 poena. Na slici prekršaj čini automobil koji iz suprotnog toka pretiče kolonu prema motociklisti. Važeći čl. 329 uz zatvor predviđa i novčanu kaznu, a kao alternativu zatvoru rad u javnom interesu uz novčanu kaznu; ponuđeni odgovor nije potpuni prikaz današnje sankcije.' };
X[8227] = { ...(X[8227] || {}), x: 'Na slici putnici tramvaja prelaze saobraćajnu traku, bez ostrva za ulazak i izlazak; vozač mora da stane dok prelaze (čl. 25 st. 3). Ova sačuvana baza očekuje 6.000–20.000 dinara i dva poena. Važeći iznos je 10.000–20.000 dinara uz dva poena (čl. 332 i 335).' };
...
X[8237] = { ...(X[8237] || {}), x: 'Znak označava kraj naselja. U pitanju je 170 km/h, uz opšte ograničenje 80: prekoračenje je 90 km/h. To spada u čl. 330 st. 1 t. 10, koji za ovaj slučaj obuhvata više od 80 do 100 km/h preko ograničenja, a ne opšti prag preko 70.' };
X[8246] = { ...(X[8246] || {}), x: 'Ova sačuvana baza očekuje zatvor od najmanje 15 dana ili 100.000–120.000 dinara i 14 poena. Prema važećem ZOBS-u, za preticanje zaustavnom trakom propisano je 20.000–40.000 dinara ili zatvor do 30 dana i šest poena (čl. 55 st. 3 t. 6, čl. 331 st. 1 t. 10 i čl. 335 st. 1 t. 20).' };
X[8251] = { ...(X[8251] || {}), x: 'Na slici se pretiče preko neisprekidane linije uz korišćenje suprotne trake. Ova sačuvana baza očekuje 15.000–30.000 dinara i šest poena. Važeći ZOBS propisuje 20.000–40.000 dinara ili zatvor do 30 dana i šest poena (čl. 331 i 335). Slika sama ne potvrđuje sve uslove nasilničkog preticanja kolone.' };
X[8254] = { ...(X[8254] || {}), x: 'Znak označava početak naselja: 110−50=60 km/h preko ograničenja. Ova sačuvana baza očekuje 15.000–30.000 dinara i sedam poena. Za ovaj opseg, više od 50 do 70 km/h, važeći ZOBS propisuje 20.000–40.000 dinara ili zatvor do 30 dana i sedam poena (čl. 331 st. 1 t. 6 i 335 st. 1 t. 10).' };
X[8256] = { ...(X[8256] || {}), x: 'Znak označava kraj naselja: 150−80=70 km/h preko ograničenja. Ova sačuvana baza očekuje 15.000–30.000 dinara i šest poena. Za ovaj opseg, više od 60 do 80 km/h, važeći ZOBS propisuje 20.000–40.000 dinara ili zatvor do 30 dana i šest poena (čl. 331 st. 1 t. 7 i 335 st. 1 t. 12).' };
X[8271] = { ...(X[8271] || {}), x: 'Na slici je crveno svetlo, bez pešaka na prelazu. Ova sačuvana baza očekuje 15.000–30.000 dinara i šest poena. Važeći ZOBS propisuje 20.000–40.000 dinara ili zatvor do 30 dana i šest poena (čl. 331 i 335). Najmanje dva prolaska na crveno u razmaku do deset minuta predstavljaju poseban slučaj nasilničke vožnje iz čl. 41.' };
X[8295] = { ...(X[8295] || {}), x: 'Ova sačuvana baza očekuje 6.000–20.000 dinara i dva poena. Važeći iznos je 10.000–20.000 dinara uz dva poena (čl. 332 i 335). Na slici je obeleženi autobus za prevoz dece na putu sa po jednom trakom za svaki smer; dok deca ulaze ili izlaze, tu se zaustavljaju vozači iz oba smera (čl. 26 st. 1).' };
X[8298] = { ...(X[8298] || {}), x: 'Ova sačuvana baza očekuje raspon 6.000–20.000 dinara i četiri poena. Prema važećem ZOBS-u, 80−50 je tačno 30 km/h preko ograničenja: kazna je 10.000 dinara (čl. 332a st. 1 t. 4). Četiri poena propisana su za više od 30, ne za tačno 30 km/h (čl. 335 st. 1 t. 9).' };
X[8301] = { ...(X[8301] || {}), x: 'Znak označava kraj naselja: 130−80=50 km/h preko ograničenja. Ova sačuvana baza očekuje 6.000–20.000 dinara i tri poena. Za ovaj opseg, više od 40 do 60 km/h, važeći ZOBS propisuje 10.000–20.000 dinara i tri poena (čl. 332 st. 1 t. 9 i 335 st. 1 t. 11).' };
X[8303] = { ...(X[8303] || {}), x: 'Na slici je preticanje kolone preko isprekidane linije. Ova sačuvana baza očekuje 6.000–20.000 dinara i dva poena. Važeći ZOBS propisuje 10.000–20.000 dinara i dva poena (čl. 332 i 335). Samo preticanje kolone ne dokazuje sve uslove nasilničke vožnje iz čl. 41.' };
X[8310] = { ...(X[8310] || {}), x: 'Prolaz je dozvoljen, ali pri skretanju desno moraš propustiti pešaka na bočnom prelazu (čl. 99 st. 2). Ova sačuvana baza očekuje 6.000–20.000 dinara i tri poena. Važeći ZOBS propisuje 10.000–20.000 dinara i tri poena (čl. 332 i 335); nije opisan zabranjen prolaz uz pešaka iz čl. 330.' };
X[8351] = { ...(X[8351] || {}), x: 'Znak označava kraj naselja: 110−80=30 km/h preko ograničenja. Ova sačuvana baza očekuje 5.000 dinara. Važeći čl. 332a st. 1 t. 5 za ovaj opseg propisuje 10.000 dinara; nijedna ponuđena opcija ne navodi taj iznos.' };
X[8375] = { ...(X[8375] || {}), x: 'Na slici je zabrana skretanja desno. Za njeno nepoštovanje propisano je 5.000 dinara (čl. 132 st. 3 i 333 st. 1 t. 78). Visina kazne ne znači da nepoštovanje znaka ne može ugroziti život.' };
X[8383] = { ...(X[8383] || {}), x: 'Znak označava početak naselja, pa je 57−50=7 km/h preko ograničenja. Za prekoračenje do 10 km/h u naselju propisano je 3.000 dinara, bez ovim osnovom propisanih poena (čl. 334 st. 1 t. 8). Zato ponuđene kazne sa četiri ili 14 poena ne odgovaraju ovom slučaju.' };
X[8385] = { ...(X[8385] || {}), x: 'Ova sačuvana baza očekuje 3.000 dinara. Prema važećem ZOBS-u, 95−80 je 15 km/h preko ograničenja van naselja, za šta čl. 333 st. 1 t. 16 propisuje 5.000 dinara. Nijedna ponuđena opcija ne navodi taj iznos.' };
X[8397] = { ...(X[8397] || {}), x: 'Ova sačuvana baza očekuje „izriče”. Prema važećem ZOBS-u, 80−50 je tačno 30 km/h: obavezna zabrana iz čl. 338 st. 1 t. 5 počinje tek kada je prekoračenje više od 30 km/h. To ne isključuje mogućnost suda da izrekne meru pod uslovima čl. 338 st. 2.' };
X[8399] = { ...(X[8399] || {}), x: 'U pitanju je 60−50=10 km/h preko ograničenja; za taj osnovni slučaj nije propisana obavezna zabrana. Za brzinu u naselju ta mera iz čl. 338 st. 1 t. 5 počinje tek preko 30 km/h prekoračenja, pa ni tačno +30 nije u tom opsegu.' };
...
X[9729] = { x: 'Na putu sa najmanje dve saobraćajne trake u istom smeru, na kome su kolone vozila, brže kretanje vozila u jednoj traci od vozila u drugoj ne smatra se preticanjem (ZOBS čl. 53 st. 4). Oba uslova su izričito navedena u pitanju.' };
...
X[10483] = { x: 'Ne pretiče se niti obilazi vozilo koje se približava pešačkom prelazu ili ga prelazi, kao ni vozilo koje se zaustavilo ili se zaustavlja radi propuštanja pešaka na prelazu (ZOBS čl. 55 st. 3 tač. 9 i 10). Pešak može biti zaklonjen vozilom ispred.' };
X[10484] = { x: "Tačni odgovori prenose opšte zabrane: preticanje ili obilaženje ne vrši se trakom za spora vozila (čl. 55 st. 3 tač. 13), niti preko neisprekidane linije uz korišćenje trake suprotnog smera (tač. 15). Samo postojanje pune linije bez korišćenja suprotne trake nije ta zabrana, kao ni dvosmerni put bez označenih traka. Zakon posebno dopušta obilaženje pod uslovima iz st. 5 i radnju pored vozila nabrojanih u st. 7; ti izuzeci ne menjaju ključ ovog pitanja o opštem pravilu." };
X[9795] = { x: 'Preticanje JESTE dozvoljeno: u podvožnjaku i na nadvožnjaku (nisu na listi zabrana) i na raskrsnici kad se krećeš putem sa prvenstvom prolaza (ZOBS čl. 57 st. 2). Za tunel važi posebna zabrana sa izuzetkom kada postoje najmanje dve trake za isti smer; podvožnjak sam po sebi nije takva zabrana.' };
...
X[8570] = { x: "Odbijanje ispitivanja na alkohol ili psihoaktivne supstance znači isključenje iz saobraćaja i obavezno zadržavanje (ZOBS čl. 279 st. 1 t. 4 i čl. 283 st. 3). Sprovođenje na analizu nije posledica odbijanja: analizu krvi, odnosno krvi i urina vozač može zahtevati ako osporava rezultat već izvršenog ispitivanja (čl. 280 st. 5)." };
const uslovnoZadrz = 'Kod 1,00 mg/ml nema obaveznog zadržavanja samo zbog tog nivoa alkohola. Vozač pod dejstvom alkohola može biti zadržan ako izražava nameru, odnosno ako postoji opasnost da će nastaviti da upravlja vozilom nakon što je isključen iz saobraćaja (ZOBS čl. 283 st. 2).';
X[8571] = { x: uslovnoZadrz };
X[8572] = { x: uslovnoZadrz };
X[8575] = { x: "Na KONTROLNI tehnički pregled vozilo se upućuje kada policijski službenik posumnja u njegovu tehničku ispravnost (ZOBS čl. 287). VANREDNI pregled je drugi postupak: obavlja se nakon opravke i pre puštanja u saobraćaj vozila kome su u nezgodi ili na drugi način oštećeni vitalni sklopovi i uređaji, odnosno koje nakon toga nije bilo u voznom stanju, kao i vozila isključenog zbog tehničke neispravnosti utvrđene na kontrolnom pregledu (čl. 265)." };
...
const iskljVozilo = 'Među razlozima za isključenje vozila iz saobraćaja (ZOBS čl. 289) jesu: neispravan uređaj za upravljanje ili zaustavljanje; drugi uređaji i oprema neispravni u meri da mogu ugroziti bezbednost saobraćaja i životnu sredinu; vozilo nije upisano u jedinstveni registar ili mu je istekla registraciona nalepnica; označeno je nepropisnim tablicama; suprotno zakonu ima ugrađene uređaje za davanje posebnih svetlosnih i zvučnih znakova koje vozač ne ukloni u roku iz naredbe policijskog službenika; pojedinačno je proizvedeno ili prepravljeno bez ispitivanja i uverenja; ili učestvuje u saobraćaju dok mu isključenje traje.';
...
X[8598] = { x: 'Isključenje vozila traje do prestanka razloga za isključenje (ZOBS čl. 292 st. 3). Oduzete tablice vraćaju se kada nadležna organizaciona jedinica MUP-a utvrdi da su ti razlozi prestali; za tehničku neispravnost utvrđenu na kontrolnom pregledu važi i propisani vanredni pregled.' };
const vanredniPregled = 'Vanredni tehnički pregled posle isključenja zbog neispravnosti utvrđene na kontrolnom pregledu po pravilu se obavlja u objektu gde je kontrolni pregled izvršen. Drugi ovlašćeni objekat moguć je samo kada to, zbog opravdanih okolnosti, dozvoli teritorijalno nadležna organizaciona jedinica MUP-a (ZOBS čl. 292 st. 4).';
...
X[8609] = { x: 'Ako vozilo nije uklonjeno u roku određenom rešenjem, uklanja se na za to određeno mesto o trošku vozača ili vlasnika, odnosno korisnika vozila (ZOBS čl. 296 st. 4).' };
...
X[8427] = { x: "Tablice za privremeno označavanje i potvrda izdaju se sa rokom važenja NAJDUŽE 15 dana (ZOBS čl. 268 st. 3)." };
const regGodina = "Opšti rok registracione nalepnice je jedna godina (ZOBS čl. 268 st. 9).";
X[8428] = { x: regGodina };
X[8429] = { x: regGodina };
X[8433] = { x: 'Saobraćajna dozvola (za vozilo) mora biti KOD VOZAČA tokom vožnje — kao i vozačka (za tebe).' };
X[8434] = { x: "Da — saobraćajna dozvola se na zahtev daje na uvid ovlašćenom licu. Polisa osiguranja i važeća registraciona nalepnica je ne zamenjuju u redovnom režimu iz ovog pitanja (ZOBS čl. 268)." };
X[8435] = { x: 'Isključeno vozilo ne učestvuje u saobraćaju dok isključenje traje — vožnja isključenim vozilom je novi prekršaj.' };
X[8436] = { x: "Registrovano vozilo sa isteklom nalepnicom može do tehničkog pregleda, opravke ili ispitivanja uz tablice za privremeno označavanje i potvrdu (ZOBS čl. 269)." };
...
X[8441] = { x: "Uništeno ili otpisano vozilo mora se odjaviti u roku od 15 dana (ZOBS čl. 274 st. 2)." };
X[8442] = { x: "Promena podatka koji se upisuje u saobraćajnu dozvolu mora se prijaviti u roku od 15 dana (ZOBS čl. 274 st. 2)." };
X[8443] = { x: "Lice koje nije vlasnik po pravilu ne sme koristiti vozilo iz lizinga ili zakupa pre upisa korišćenja u saobraćajnu dozvolu (ZOBS čl. 274 st. 3). Ovo se ne odnosi na vozila za iznajmljivanje bez vozača (st. 5)." };
...
X[8451] = { x: "Vozilo jednoznačno određuje identifikaciona oznaka proizvođača (ZOBS čl. 253). Registraciona nalepnica vezana je za registraciju, a broj motora označava motor, koji je zamenljiv deo — ta dva podatka ne zamenjuju identifikacionu oznaku vozila." };
X[8461] = { x: "Vanredni pregled obavlja se nakon popravke, pre vraćanja u saobraćaj vozila sa oštećenim vitalnim sklopovima ili vozila isključenog zbog neispravnosti utvrđene na kontrolnom pregledu (ZOBS čl. 265). Pregled po nalogu radi kontrole je kontrolni, a šestomesečni je redovni." };
X[8462] = { x: 'KONTROLNI pregled: po nalogu ovlašćenog lica MUP-a ili inspektora za drumski saobraćaj — na sumnju, ne po kalendaru.' };
X[10687] = { x: "Redovni godišnji pregled se po opštem pravilu obavlja pre upisa u registar ili izdavanja nalepnice (ZOBS čl. 264 st. 2)." };
X[10688] = { x: 'Godišnji pregled važi za registraciju ako je obavljen najranije 30 DANA pre zahteva.' };
X[10705] = { x: "Redovni i vanredni pregled vrše se samo na čistom vozilu u voznom stanju (Pravilnik o tehničkom pregledu vozila, čl. 29). Tehnička ispravnost se pregledom tek utvrđuje." };
X[10706] = { x: "Redovni i vanredni pregled po pravilu se vrše na neopterećenom vozilu (Pravilnik, čl. 29)." };
...
X[8088] = { x: motoputDef };
X[8089] = { x: "Motoput je državni put namenjen isključivo za saobraćaj motocikala, putničkih vozila, teretnih vozila i autobusa, sa ili bez priključnih vozila, i obeležen propisanim saobraćajnim znakom (ZOBS čl. 7 t. 6). Potpuna kontrola pristupa i zaustavna traka za svaki smer nisu uslovi iz te definicije; znak se ne zamenjuje oznakom na kolovozu." };
X[8086] = { x: "Zemljani put je put bez izgrađenog kolovoznog zastora, čak i kada na priključku na drugi put ima izgrađen zastor (ZOBS čl. 7 t. 9). Kada se sa njega uključuješ na put sa savremenim kolovoznim zastorom, dužan si da propustiš sva vozila koja se kreću tim putem (čl. 47)." };
...
X[8124] = { x: zona30 };
X[8125] = { x: zona30 };
X[10702] = { x: "Pešačka zona je prvenstveno namenjena saobraćaju pešaka. Nadležni organ opštine ili grada može u određenom vremenu dozvoliti kretanje određenih vozila brzinom pešaka, bez njihovog ugrožavanja (ZOBS čl. 160). U zoni usporenog saobraćaja kolovoz koriste i pešaci i vozila, ali vozač ne sme ometati pešake i bicikliste (čl. 161). Zona „30” označava ograničenje do 30 km/h (čl. 162)." };
X[10603] = { x: 'U pešačkoj zoni dozvoljena vozila kreću se brzinom KRETANJA PEŠAKA — pešak je merilo, ne broj na semaforu.' };
X[10604] = { x: "Zona usporenog saobraćaja je deo puta, ulice ili naselja u kome kolovoz koriste pešaci i vozila, označen propisanom signalizacijom (ZOBS čl. 161). Vozač ne sme ometati pešake i bicikliste i kreće se brzinom pešaka, najviše 10 km/h." };
...
X[10606] = { x: "Zona škole u naselju: brzina je ograničena do 30 km/h od 7 do 21 čas, osim ako je saobraćajnim znakom drugačije određeno VREME zabrane (ZOBS čl. 163). Odredba ne ograničava ovo pravilo samo na radne dane." };
X[10607] = { x: "Zona škole van naselja: brzina je ograničena do 50 km/h od 7 do 21 čas, osim ako je saobraćajnim znakom drugačije određeno VREME zabrane (ZOBS čl. 163). Odredba ne ograničava ovo pravilo samo na radne dane." };
...
X[10610] = { x: "Vozač mora isključiti motor kada vozilo stoji duže od tri minuta (ZOBS čl. 164). To je poseban uslov za gašenje motora, nezavisan od definicija zaustavljanja i parkiranja." };
...
X[8083] = { ...(X[8083] || {}), x: "Ulica i pešačka staza su izričito vrste puta prema ZOBS čl. 7 t. 7 i 25. Ostali ponuđeni opisi ne sadrže uslove iz zakonske definicije puta; naročito, dozvola vlasnika sama nije uslov određen zakonom ili drugim propisom." };
X[8084] = { ...(X[8084] || {}), x: "Biciklistička staza i zemljani put izričito su putevi prema ZOBS čl. 7 t. 26 i 9. Generički plato nije samim tim trg: za trg zakon traži urbanistički plan i proglašenje nadležnog organa (t. 27); ostali ponuđeni opisi ne utvrđuju put." };
...
X[9766] = { ...(X[9766] || {}), x: "Tačni su odgovori da se radnja ne sme izvesti ako se posle nje ne možeš vratiti u svoju traku bez ometanja ili ugrožavanja drugih i da se ne sme izvesti zaustavnom trakom (ZOBS čl. 55 st. 3 tač. 5 i 6). Zona „30” i zona škole same po sebi nisu posebne zabrane preticanja ili obilaženja." };
...
X[10781] = { x: 'Pravilo za znakove opasnosti je 150–250 m ispred opasnog mesta (Pravilnik o signalizaciji čl. 22). Van naselja odstupanje traži dopunsku tablu sa udaljenošću i obrazloženje u saobraćajnom projektu; u naselju znak može biti bliže od 150 m uz obrazloženje u projektu. Posebna mesta postavljanja pojedinih znakova uređuje čl. 23.' };
...
X[10782] = { x: 'VAN naselja znak opasnosti postavljen bliže od 150 m ili dalje od 250 m mora imati dopunsku tablu sa udaljenošću do opasnog mesta, a odstupanje se obrazlaže u saobraćajnom projektu (Pravilnik o signalizaciji čl. 22). Vrsta opasnosti se vidi iz samog znaka; tabla označava udaljenost.' };
...
X[10841] = { x: 'Opšte pravilo je da se znak izričite naredbe postavlja NEPOSREDNO ISPRED mesta odakle nastaje obaveza (Pravilnik, čl. 32). Može se postaviti i ranije, ali tada mora imati dopunsku tablu sa udaljenošću do mesta od kog naredba važi. Zato ponuđenih 100 m i 150–250 m nisu opšte pravilo za ove znakove.' };
...
X[8228] = { x: "Ova sačuvana baza očekuje zatvor od najmanje 15 dana ili 100.000–120.000 dinara i 14 poena. Važeći ZOBS razlikuje lice bez dozvole ni za jednu kategoriju, odnosno sa oduzetom dozvolom (čl. 330 st. 1 t. 1), od vozača koji je položio drugu kategoriju (čl. 331 st. 1 t. 90a). Pitanje ne razdvaja te slučajeve; za poene je važna i izdata srpska dozvola iz čl. 323." };
X[8229] = { x: 'Ova sačuvana baza očekuje „kaznom zatvora od najmanje 15 dana ili novčanom kaznom od 100.000 dinara do 120.000 dinara i 14 kaznenih poena”. Prema važećem ZOBS-u: Član 329: zatvor 30–60 dana uz 120.000–140.000 dinara ili rad u javnom interesu 240–360 sati uz isti novčani raspon; 15 kaznenih poena i zabrana najmanje devet meseci, za osnovni slučaj bez nezgode (čl. 329).' };
X[8230] = { x: 'Odbijanje ispitivanja je poseban prekršaj iz čl. 330 st. 1 t. 5: najmanje 15 dana zatvora ili 100.000–120.000 dinara i 14 poena. Ne znači da zakon pretpostavlja najgori nalaz; više od 2,00 mg/ml pripada drugom režimu, nasilničkoj vožnji iz čl. 329.' };
...
X[8247] = { x: "Ova sačuvana baza očekuje zatvor od najmanje 15 dana ili 100.000–120.000 dinara i 14 poena. Prema važećem ZOBS-u, nedozvoljeno kretanje zaustavnom trakom nosi 20.000–40.000 dinara ili zatvor do 30 dana, šest poena i zabranu najmanje tri meseca (čl. 104 st. 2, 331 st. 1 t. 24a, 335 st. 1 t. 46a i 338 st. 1 t. 27)." };
X[8340] = { x: "Ova sačuvana baza očekuje odgovornost vlasnika zato što je omogućio prekršaj. To nije isto što i današnji osnov iz čl. 247: na poziv se u roku od osam dana daju podaci i dokaz o vozaču, uz izuzetak dokazane neovlašćene upotrebe. Sama činjenica da vozač nije identifikovan ne utvrđuje sve te uslove." };
...
X[8260] = { x: 'Ova sačuvana baza očekuje „novčanom kaznom od 15.000 dinara do 30.000 dinara i 6 kaznenih poena”. Prema važećem ZOBS-u, novčana kazna od 20.000 do 40.000 dinara ili zatvor do 30 dana i šest kaznenih poena (čl. 331, 335).' };
X[8261] = { x: 'Ova sačuvana baza očekuje „novčanom kaznom od 15.000 dinara do 30.000 dinara i 6 kaznenih poena”. Prema važećem ZOBS-u, novčana kazna od 20.000 do 40.000 dinara ili zatvor do 30 dana i šest kaznenih poena (čl. 331, 335).' };
X[8264] = { x: 'Ova sačuvana baza očekuje „novčanom kaznom od 15.000 dinara do 30.000 dinara i 6 kaznenih poena”. Prema važećem ZOBS-u, novčana kazna od 20.000 do 40.000 dinara ili zatvor do 30 dana i šest kaznenih poena (čl. 331, 335).' };
X[8265] = { x: 'Ova sačuvana baza očekuje „novčanom kaznom od 15.000 dinara do 30.000 dinara i 6 kaznenih poena”. Prema važećem ZOBS-u, novčana kazna od 20.000 do 40.000 dinara ili zatvor do 30 dana i šest kaznenih poena (čl. 331, 335).' };
X[8266] = { x: 'Ova sačuvana baza očekuje „novčanom kaznom od 15.000 dinara do 30.000 dinara i 8 kaznenih poena”. Prema važećem ZOBS-u, novčana kazna od 20.000 do 40.000 dinara ili zatvor do 30 dana i osam kaznenih poena (čl. 331, 335).' };
X[8272] = { x: 'Ova sačuvana baza očekuje „novčanom kaznom od 15.000 do 30.000 dinara i 6 kaznenih poena”. Prema važećem ZOBS-u, novčana kazna od 20.000 do 40.000 dinara ili zatvor do 30 dana i šest kaznenih poena (čl. 331, 335).' };
X[8273] = { x: 'Ova sačuvana baza očekuje stari raspon 15.000–30.000 dinara i dva poena. Za napuštanje uviđaja kod manje materijalne štete važeći ZOBS propisuje 20.000–40.000 dinara ili zatvor do 30 dana i dva poena (čl. 171 st. 2, 331 i 335). Pitanje ne navodi veličinu štete: velika materijalna šteta može potpasti pod čl. 330 i bez povređenih.' };
X[8274] = { x: "Ova sačuvana baza očekuje 15.000–30.000 dinara i pet poena. Za vožnju sa dozvolom koja je istekla pre više od šest meseci važeći čl. 332a st. 1 t. 13 propisuje 10.000 dinara, bez ovim osnovom propisanih poena. Do šest meseci kazna je 5.000 dinara (čl. 333 st. 1 t. 102)." };
X[8275] = { x: "Ova sačuvana baza očekuje 15.000–30.000 dinara. Za opisanu protivpravnu upotrebu dozvola važeći čl. 331 propisuje 20.000–40.000 dinara ili zatvor do 30 dana. Čl. 183 st. 2 ne zabranjuje svako posedovanje dve dozvole: obaveza korišćenja srpske obuhvata važeću stranu dozvolu koja nije izdata zamenom srpske." };
X[8276] = { x: 'Ova sačuvana baza očekuje „novčanom kaznom od 15.000 do 30.000 dinara i 3 kaznena poena”. Prema važećem ZOBS-u, novčana kazna od 20.000 do 40.000 dinara ili zatvor do 30 dana i tri kaznena poena (čl. 331, 335).' };
X[8277] = { x: 'Ova sačuvana baza očekuje „novčanom kaznom od 15.000 do 30.000 dinara i 8 kaznenih poena”. Prema važećem ZOBS-u, novčana kazna od 20.000 do 40.000 dinara ili zatvor do 30 dana i osam kaznenih poena (čl. 331, 335).' };
...
X[8281] = { x: 'Ova sačuvana baza očekuje 15.000–30.000 dinara. Važeći čl. 247 traži da vlasnik na poziv u roku od osam dana dostavi podatke i dokaz ko je upravljao, uz izuzetak dokazane neovlašćene upotrebe. Za povredu važi najmanje 15 dana zatvora ili 100.000–120.000 dinara, izričito bez poena i zaštitne mere (čl. 330 st. 1 t. 23 i st. 4,6).' };
X[8282] = { x: 'Ova sačuvana baza očekuje „novčanom kaznom od 15.000 do 30.000 dinara i 6 kaznena poena”. Prema važećem ZOBS-u, novčana kazna od 20.000 do 40.000 dinara ili zatvor do 30 dana i šest kaznenih poena (čl. 331, 335, 338).' };
X[8283] = { x: 'Ova sačuvana baza očekuje „novčanom kaznom od 15.000 do 30.000 dinara i 6 kaznena poena”. Prema važećem ZOBS-u, novčana kazna od 20.000 do 40.000 dinara ili zatvor do 30 dana i šest kaznenih poena (čl. 331, 335).' };


// --- Kaznene mere, podtura C: blaža srednja klasa (niži raspon, 0-6 poena), 22 pitanja — bez iznosa ---
X[8296] = { x: 'Ova sačuvana baza očekuje „novčanom kaznom od 6.000 do 20.000 dinara”. Prema važećem ZOBS-u, za povredu člana 32 st. 3 i 4: 5.000 dinara (čl. 333).' };
X[8302] = { x: 'Ova sačuvana baza očekuje „novčanom kaznom od 6.000 do 20.000 dinara i 2 kaznena poena”. Prema važećem ZOBS-u, novčana kazna od 10.000 do 20.000 dinara i dva kaznena poena za protivpravan osnovni slučaj (čl. 332, 335).' };
X[8305] = { x: 'Ova sačuvana baza očekuje 6.000–20.000 dinara i dva poena. Za zabranjeno preticanje ispred raskrsnice važeći ZOBS propisuje 10.000–20.000 dinara i dva poena (čl. 57, 332 i 335). Ne proširuj zabranu na izuzetke koje član 57 dopušta, uključujući raskrsnicu sa kružnim tokom.' };
X[8306] = { x: 'Ova sačuvana baza očekuje „novčanom kaznom od 6.000 do 20.000 dinara i 4 kaznena poena”. Prema važećem ZOBS-u, novčana kazna od 10.000 do 20.000 dinara i četiri kaznena poena (čl. 332, 335).' };
X[8314] = { x: 'Ova sačuvana baza očekuje 6.000–20.000 dinara. Za neprinudno stajanje na autoputu važeći čl. 332 propisuje 10.000–20.000 dinara. Ako je vozač prinuđen da stane, čl. 105 st. 3 nalaže zaustavnu traku i što brže uklanjanje vozila; to nije isti prekršaj.' };
X[8318] = { x: 'Ova sačuvana baza očekuje „novčanom kaznom od 6.000 dinara do 20.000 dinara i 3 kaznena poena”. Prema važećem ZOBS-u, novčana kazna od 10.000 do 20.000 dinara i tri kaznena poena (čl. 332, 335).' };
X[8320] = { x: 'Ova sačuvana baza očekuje „novčanom kaznom od 6.000 dinara do 20.000 dinara i 2 kaznena poena”. Prema važećem ZOBS-u, novčana kazna od 10.000 do 20.000 dinara i dva kaznena poena za protivpravan osnovni slučaj (čl. 332, 335).' };
X[8321] = { x: 'Ova sačuvana baza očekuje „novčanom kaznom od 6.000 dinara do 20.000 dinara i 2 kaznena poena”. Prema važećem ZOBS-u, novčana kazna od 10.000 do 20.000 dinara i dva kaznena poena za protivpravan osnovni slučaj (čl. 332, 335).' };
X[8322] = { x: 'Ova sačuvana baza očekuje 6.000–20.000 dinara i dva poena. Za nedozvoljeno kretanje u pešačkoj zoni važeći ZOBS propisuje 10.000–20.000 dinara i dva poena (čl. 160, 332 i 335). Određenim vozilima može biti dozvoljeno kretanje u određeno vreme, brzinom pešaka; taj dozvoljeni slučaj nije prekršaj.' };
X[8323] = { x: 'Ova sačuvana baza očekuje „novčanom kaznom od 6.000 do 20.000 dinara i 4 kaznena poena”. Prema važećem ZOBS-u, novčana kazna od 10.000 do 20.000 dinara i četiri kaznena poena (čl. 332, 335).' };
X[8324] = { x: 'Ova sačuvana baza očekuje „novčanom kaznom od 6.000 do 20.000 dinara”. Prema važećem ZOBS-u, novčana kazna od 10.000 do 20.000 dinara za opisani protivpravan osnovni slučaj (čl. 332).' };
X[8326] = { x: 'Ova sačuvana baza očekuje „novčanom kaznom od 6.000 do 20.000 dinara i 2 kaznenih poena”. Prema važećem ZOBS-u, za istek dozvole do šest meseci: 5.000 dinara, bez ovim osnovom propisanih poena i obavezne zabrane (čl. 333, 335, 338).' };
X[8328] = { x: 'Ova sačuvana baza očekuje „novčanom kaznom od 6.000 do 20.000 dinara”. Prema važećem ZOBS-u, novčana kazna od 10.000 dinara za opisani protivpravan osnovni slučaj (čl. 332a).' };
X[8329] = { x: 'Ova sačuvana baza očekuje „novčanom kaznom od 6.000 do 20.000 dinara i 6 kaznenih poena”. Prema važećem ZOBS-u, za srednju alkoholisanost: 10.000–20.000 dinara i šest kaznenih poena (čl. 332, 335).' };
X[8330] = { x: 'Ova sačuvana baza očekuje 6.000–20.000 dinara i šest poena. Važeća novčana kazna za srednju alkoholisanost je 10.000–20.000 dinara (čl. 332). Za poene je važan i čl. 323: kandidat koji već ima srpsku dozvolu nije isti slučaj kao kandidat kome dozvola još nije izdata.' };
X[8333] = { x: 'Ova sačuvana baza očekuje „novčanom kaznom od 6.000 do 20.000 dinara”. Prema važećem ZOBS-u, novčana kazna od 10.000 do 20.000 dinara za opisani protivpravan osnovni slučaj (čl. 332).' };
X[8334] = { x: 'Ova sačuvana baza očekuje 6.000–20.000 dinara. Za odgovornog vlasnika važeći iznos je 10.000–20.000 dinara (čl. 332 st. 1 t. 92). Ta odredba izuzima vožnju supružnika, trajnog vanbračnog partnera, srodnika u pravoj liniji, brata ili sestre i usvojioca ili usvojenika; nije tačno da vlasnik uvek odgovara.' };
X[8335] = { x: 'Ova sačuvana baza očekuje „novčanom kaznom od 6.000 do 20.000 dinara”. Prema važećem ZOBS-u, novčana kazna od 10.000 do 20.000 dinara za opisani protivpravan osnovni slučaj (čl. 332).' };
X[8337] = { x: 'Ova sačuvana baza očekuje 6.000–20.000 dinara i dva poena. Po važećem ZOBS-u iznos zavisi od trajanja isteka nalepnice: do 30 dana 5.000, preko 30 dana 10.000 dinara (čl. 333 st. 1 t. 105 i 332a st. 1 t. 21), bez ovim osnovima propisanih poena. Pitanje ne navodi koliko je vremena prošlo.' };
X[8338] = { x: 'Ova sačuvana baza očekuje „novčanom kaznom od 6.000 do 20.000 dinara”. Prema važećem ZOBS-u, novčana kazna od 10.000 do 20.000 dinara za opisani protivpravan osnovni slučaj (čl. 332).' };
X[8339] = { x: 'Ova sačuvana baza očekuje „novčanom kaznom od 6.000 do 20.000 dinara”. Prema važećem ZOBS-u, novčana kazna od 10.000 do 20.000 dinara za opisani protivpravan osnovni slučaj (čl. 332).' };
X[8341] = { x: 'Ova sačuvana baza očekuje 6.000–20.000 dinara. Za dokazanu povredu današnje obaveze iz čl. 247 važi najmanje 15 dana zatvora ili 100.000–120.000 dinara, izričito bez poena i zaštitne mere (čl. 330 st. 1 t. 23 i st. 4,6). Pitanje ne utvrđuje poziv, rok i propust potrebne za taj osnov.' };
...
X[8344] = { x: 'Ova sačuvana baza očekuje „novčanom kaznom od 5.000 dinara”. Prema važećem ZOBS-u, novčana kazna od 10.000 dinara za opisani protivpravan osnovni slučaj (čl. 332a).' };
...
X[8355] = { x: 'Za opisano parkiranje na pešačkom prelazu propisano je 5.000 dinara (čl. 66 i 333). Za osnovni slučaj nije propisana obavezna zabrana upravljanja; to nije zato što parkiranje „nije vožnja”, niti je time isključena sudska mogućnost iz čl. 338 st. 2.' };
...
X[8368] = { x: 'Ova sačuvana baza očekuje „novčanom kaznom od 5.000 dinara”. Prema važećem ZOBS-u, novčana kazna od 10.000 dinara za opisani protivpravan osnovni slučaj (čl. 332a).' };
...
X[8370] = { x: 'Za povredu pravila korišćenja krajnje desne trake na autoputu propisano je 5.000 dinara (čl. 104 st. 1 i 333). Pored preticanja, zakon dopušta drugu traku i kada je desna zauzeta vozilima koja se kreću u koloni.' };
X[8376] = { x: 'Ova sačuvana baza očekuje „novčanom kaznom od 5.000 dinara”. Prema važećem ZOBS-u, novčana kazna od 10.000 dinara za opisani protivpravan osnovni slučaj (čl. 332a).' };
...
X[8406] = { x: 'Preticanje vozila koje je već dalo znak da pretiče zabranjeno je članom 55 st. 3 t. 3, ali za taj osnovni slučaj nije propisana obavezna zabrana upravljanja. Reči „istom trakom” opisuju početni položaj vozila; ne znače da manevar nužno ostaje u toj traci. Sudska mogućnost iz čl. 338 st. 2 nije isključena.' };
X[8407] = { x: 'Za zabranjeno preticanje preko neisprekidane linije uz korišćenje suprotne trake propisana je obavezna zabrana najmanje tri meseca (čl. 338 st. 1 t. 13). To ne ukida izuzetke iz čl. 55 st. 7 za određena spora vozila uz uslove bezbednog preticanja.' };
...
X[8411] = { x: 'Ova sačuvana baza očekuje da se mera ne izriče. Za opisano parkiranje na pešačkom prelazu nije propisana obavezna zabrana, ali član 338 st. 2 ne isključuje sudsku mogućnost njene primene. Razlog nije opšta tvrdnja da parkiranje nije radnja u vožnji.' };
X[8412] = { x: 'Vozilo nije upisano u jedinstveni registar, što nije isto što i samo istekla nalepnica. Za ovaj osnov propisana je zabrana najmanje tri meseca (čl. 338 st. 1 t. 59). Iz neupisanosti ne zaključuj da vozilo sigurno nema osiguranje ili obavljen pregled.' };
X[8413] = { x: "Ova sačuvana baza očekuje da se mera izriče. Prema važećem ZOBS-u, za istek dozvole preko šest meseci propisano je 10.000 dinara (čl. 332a st. 1 t. 13), a obavezna zabrana samo po tom osnovu nije propisana. To ne isključuje sudsku mogućnost iz čl. 338 st. 2." };
...
for (const [key, expected] of [['brzine', 6], ['kategorije-vozila', 4], ['put-pojmovi', 1], ['vozilo-tehnika', 4], ['kaznene-klase', 13], ['preticanje', 3], ['skretanje', 2], ['iskljucenje', 3]]) {
  let count = 0;
...
// Sačuvaj pregledane oznake sa slika: oblik slova U, rimske I/II i jedinice m/t.
// Korekcije važe samo za ove izvore; promenjen opis zahteva novi pregled oba pisma.
{
  for (const [id, staro, novo] of [
    ...
    [10851,"слова У","слова U"],
    [10858,"Бело И у средини","Бело I у средини"],
    [10858,"док ИИ везује","док II везује"],
    [10863,"ознака ИИ","ознака II"],
    [10863,"а И непаран","а I непаран"],
    [10861,"3,5 т","3,5 t"]
  ]) {
    if (out.byQ[id].x.c.split(staro).length !== 2) throw new Error('Pitanje ' + id + ': neočekivana oznaka');
    out.byQ[id].x.c = out.byQ[id].x.c.replace(staro, novo);
  }
  for (const [staro, novo] of [
    ["<tr><td>Ознака <b>И</b> вс ознака <b>ИИ</b></td><td>Наизменично паркирање: <b>И = забрањено НЕПАРНИМ данима</b>, <b>ИИ = забрањено ПАРНИМ данима</b>. Памтилица: И је један (непаран број), ИИ је два (паран)</td></tr>","<tr><td>Ознака <b>I</b> вс ознака <b>II</b></td><td>Наизменично паркирање: <b>I = забрањено НЕПАРНИМ данима</b>, <b>II = забрањено ПАРНИМ данима</b>. Памтилица: I је један (непаран број), II је два (паран)</td></tr>"],
    ["3,5 т","3,5 t"],
    ["<tr><td>Број (м) и коте <b>лево-десно</b></td><td><b>ШИРИНА</b> прелази означену (без речи „укупна\")</td></tr>","<tr><td>Број (m) и коте <b>лево-десно</b></td><td><b>ШИРИНА</b> прелази означену (без речи „укупна\")</td></tr>"],
    ["<tr><td>Број (м) и коте <b>горе-доле</b></td><td><b>Укупна ВИСИНА</b> прелази означену</td></tr>","<tr><td>Број (m) и коте <b>горе-доле</b></td><td><b>Укупна ВИСИНА</b> прелази означену</td></tr>"],
    ["<tr><td>Силуета возила + број (м)</td><td><b>Укупна ДУЖИНА</b> прелази означену — важи и за скупове возила</td></tr>","<tr><td>Силуета возила + број (m)</td><td><b>Укупна ДУЖИНА</b> прелази означену — важи и за скупове возила</td></tr>"],
    ["<tr><td>Број са ознаком <b>т</b>, без симбола осовине</td><td><b>Укупна МАСА</b> прелази означену — и за скупове возила</td></tr>","<tr><td>Број са ознаком <b>t</b>, без симбола осовине</td><td><b>Укупна МАСА</b> прелази означену — и за скупове возила</td></tr>"],
    ["<tr><td>Број <b>т</b> на симболу <b>осовине</b> (точкови)</td><td><b>ОСОВИНСКО ОПТЕРЕЋЕЊЕ</b> веће од означеног</td></tr>","<tr><td>Број <b>t</b> на симболу <b>осовине</b> (точкови)</td><td><b>ОСОВИНСКО ОПТЕРЕЋЕЊЕ</b> веће од означеног</td></tr>"]
  ]) {
